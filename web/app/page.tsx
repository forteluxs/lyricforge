...
export default function Home() {
  ...
  return (
    <div className="min-h-screen selection:bg-indigo-500/30 selection:text-indigo-200 pb-20">
      <div className="max-w-[1200px] mx-auto px-4 py-8 sm:py-12">
        ...
        <div className="text-center space-y-3 mb-10 sm:mb-16">
          ...
          >
            Generate professional song lyrics complete with structural prompts optimized for Suno AI and Udio.
          </motion.p>
        </div>
